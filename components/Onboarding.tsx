            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-slate-600 mt-2">
                  Let's get your intelligent assistant up and running in minutes
                </p>
              </div>
              {step === 1 ? (
                  ...
                  <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4 mt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-xs text-slate-700">
                        ...
                        <p>
                          Your workspace is where all your AI agents live. After
                          creating it, you can invite team members, manage
                          multiple agents, and track analytics.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-6 animate-in fade-in duration-500">
                  ...
                  {formData.knowledgeType === "url" ? (
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-slate-500 mt-2">
                        Add product details, FAQs, policies, or any information
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-xs text-slate-700">
                        ...
                        <p>
                          You can add more sources, upload files, and sync with
                          tools like Notion, Google Drive, or Zendesk later from
                          your dashboard.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-xs text-slate-700">
                        ...
                        <p>
                          ...
                          "Complete Setup" to launch your agent. You can refine
